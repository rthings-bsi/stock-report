      ...
      <div className="overflow-x-auto max-h-[480px] overflow-y-auto rounded-xl border border-slate-200/80 shadow-xs bg-white">
        <table className="w-full text-left text-xs border-collapse">
          <thead className="sticky top-0 z-10 bg-slate-50/80 backdrop-blur-sm text-slate-500 font-semibold text-[11px] uppercase tracking-wider border-b border-slate-200/80 select-none">
            <tr className="group">
              <th className="py-3 px-3.5 text-center font-bold text-slate-500 w-10">#</th>
          ...
          <tbody className="divide-y divide-slate-100/90 text-slate-800 bg-white">
            {sorted.map((item, idx) => (
              <tr key={`${item.gudang}-${item.kodeMaterial}-${item.batch}-${idx}`} className="hover:bg-emerald-50/30 transition-all duration-150 group">
                ...
                <td className="py-3 px-3.5">
                  ...
                  <span className="text-xs text-slate-500 font-sans truncate block max-w-[240px]" title={item.customer}>
                    {item.customer}
                  </span>
                </td>
                <td className="py-3 px-3.5 font-mono text-xs font-semibold text-slate-800 whitespace-nowrap">
                  {item.kodeMaterial}
                </td>
                ...
                <td className="py-3 px-3.5 text-center font-mono text-[11px] text-slate-600 whitespace-nowrap">
                  {item.incDate || '-'}
                </td>
          ...
          <tfoot className="sticky bottom-0 z-20 bg-slate-50/95 backdrop-blur-xs font-bold text-xs text-slate-900 border-t border-slate-200/80">
            <tr>
              ...
              <td className="py-3 px-3.5 text-right text-amber-950 font-mono font-bold">
          ...
          <div className="flex-1 overflow-auto p-4 space-y-4 max-h-[60vh]">
            ...
            <div>
              ...
              <div className="overflow-x-auto rounded-xl border border-slate-200/80 shadow-xs bg-white">
                <table className="w-full text-left text-xs border-collapse">
                  <thead className="bg-slate-50/80 backdrop-blur-sm text-slate-500 font-semibold text-[11px] uppercase tracking-wider border-b border-slate-200/80 select-none">
                    <tr>
                      <th className="py-3 px-3.5 font-bold">Tahun Produksi (Prod. Year)</th>
                      <th className="py-3 px-3.5 text-right font-bold text-amber-950">Tonase Slow Moving (Ton)</th>
                      <th className="py-3 px-3.5 text-right font-bold">% Proporsi</th>
                      <th className="py-3 px-3.5 text-right font-bold text-slate-700">Jumlah Batang</th>
                      <th className="py-3 px-3.5 text-right font-bold text-slate-700">Jumlah Item</th>
                      <th className="py-3 px-3.5 text-center font-bold text-slate-600">Aksi Detail</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100/90 text-slate-800 bg-white">
                        ...
                        >
                          <td className="py-3 px-3.5 font-bold text-slate-900 whitespace-nowrap">
                            <div className="flex items-center gap-2">
                              <span className={`px-2 py-0.5 rounded-md text-[11px] font-bold font-mono border ${
                                isSelectedYear
                          ...
                          <td className="py-3 px-3.5 text-right font-bold font-mono text-amber-950 text-xs">
                          ...
                          <td className="py-3 px-3.5 text-right font-mono text-slate-700 font-semibold">
                          ...
                          <td className="py-3 px-3.5 text-center">
                            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-emerald-700 hover:text-emerald-950 bg-emerald-50/80 hover:bg-emerald-100/90 border border-emerald-200/70 text-xs font-semibold transition-all shadow-2xs">
            ...
            {modalFilteredSlowItems.length > 0 && (
              <div className="pt-2">
                ...
                <div className="overflow-x-auto rounded-xl border border-slate-200/80 shadow-xs max-h-[36vh] bg-white">
                  <table className="w-full text-left text-xs border-collapse">
                    <thead className="sticky top-0 z-10 bg-slate-50/80 backdrop-blur-sm text-slate-500 font-semibold text-[11px] uppercase tracking-wider border-b border-slate-200/80 select-none">
                      <tr>
                        ...
                        <th className="py-3 px-3.5 text-center font-bold text-slate-700">Prod. Year</th>
                        <th className="py-3 px-3.5 text-right font-bold text-slate-900">Qty (Btg)</th>
                        <th className="py-3 px-3.5 text-right font-bold text-amber-950">Tonase (Ton)</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100/90 text-slate-800 bg-white">
